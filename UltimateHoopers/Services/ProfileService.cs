                ...
                if (paginatedResult != null && paginatedResult != null)
                {
                    ...
                    foreach (var item in paginatedResult.Items)
                    {
                        ...
                        var profile = new Profile
                        {
                            ...
                            PlayerNumber = item.Profile.PlayerNumber,
                            City = item.Profile.City,
                            Height = item.Profile.Height,
                            ImageURL = item.Profile.ImageURL,
                            Bio = item.Profile.Bio,
                            Ranking = item.Profile.Ranking,
                            StarRating = item.Profile.StarRating,
                            Weight = item.Profile.Weight,
                            PlayerArchetype = item.Profile.PlayerArchetype,
                            Zip = item.Profile.Zip,
                            Status = item.Profile.Status,
                            Points = item.Profile.Points,
                            LastRunDate = item.Profile.LastRunDate,
                            TopRecord = item.Profile.TopRecord,
                            OnSquad = item.Profile.OnSquad,
                            GameStatistics = item.Profile.GameStatistics,
                            ScoutingReport = item.Profile.ScoutingReport,
