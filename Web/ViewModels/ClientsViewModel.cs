...
namespace Website.ViewModels
{
    public class ClientsViewModel
    {
        ...
        public static ClientsViewModel FromPaginatedResult(CursorPaginatedResultDto<ClientDetailViewModelDto> result, string sortBy = "Points", int limit = 20)
        {
            if (result == null)
                return new ClientsViewModel { CurrentSortBy = sortBy, PageSize = limit };
